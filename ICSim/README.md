...
From this document I was able to successfully set up a CANBUS simulator through Kali Linux VM, I change the message passing of different controls, and learned how CANBUS works through this simulator.
